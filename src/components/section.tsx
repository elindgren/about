...
const Section: React.FC<SectionProps> = ({ title, children }) => {
    const sectionStyles =
        'rounded-lg my-12 mx-2 md:w-3/4 lg:w-196 flex flex-col text-light-text-primary dark:text-dark-text-primary border border-light-border dark:border-dark-border bg-section-background'
    return (
